...
<body class="index-bg">
    <div class="container" id="container">
        <div class="form-container secondary-container">
            <form:form cssClass="form-css" action="processSignup" modelAttribute="signupData">
                <h1>Signup</h1>
                <div>
                    ...
                    <br>
                    <form:password cssClass="in-fields" placeholder="Confirm Password" path="confirmPassword"/>
        ...
        <div class="text-container">
            <div class="text">
                <div class="panel text-right">
                    ...
                    <p>This is a signup form created using Spring MVC, Hibernate and JSP pages.
                </div>
            </div>
        </div>
    </div>
